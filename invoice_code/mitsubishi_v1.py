    ...
    try:
        ...
        for index, row in table_data.iterrows():
            ...
            if row['TEXT'] == 'PC' and not 'qty' in msg:
                ...
                msg['qty'] = table_data.iloc[index - 3]['TEXT']
                print("QTY:",msg['qty'])

                if not msg['qty'].isdigit():
                    print('Not QTY is True __:')
                    msg['qty'] = row['TEXT']
            ...
            if row['TEXT'].__contains__('Discount'):
                #         print(table_data.iloc[index-1]['TEXT'])
                msg['disc'] = table_data.iloc[index - 1]['TEXT'].replace('-', '')

            if row['TEXT'].__contains__("Commodity"):
                msg['total'] = table_data.iloc[index - 3]['TEXT']

                if not msg['total'][0].isdigit():
                    print("Total:", msg['total'])
...
if __name__ == '__main__':
    ...
    # filename = '../multipdf/Mitsubishi -  0052034922.pdf'
